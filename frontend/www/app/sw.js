...
const STATIC_ASSETS = [
  '/app/',
  '/app/app-v8.js?v=12.99',
  '/app/views-modules-v2.js?v=1.7',
  '/app/views-professionals-v8.js?v=1.17',
  '/app/views-innovations.js?v=1.1',
  '/app/views-chat.js?v=2.2',
  '/app/views-admin.js?v=2.5',
  '/app/app-i18n.js?v=1.2',
  '/app/pwa.js?v=1.2',
